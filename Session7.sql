...
SELECT Name, ModifiedDate FROM Person.ContactType
SELECT Name + '.' + Name AS 'Contact Name' FROM Person.ContactType
...
SELECT COUNT(NationalIDNumber) AS TitleCount FROM HumanResources.Employee
